...
See also L<https://github.com/makamaka/JSON-PP/commit/87bd6a4>
and L<https://github.com/makamaka/JSON-PP/commit/81dd25b>.
...
=item * Rename C<Result>, in line with the official drivers.
