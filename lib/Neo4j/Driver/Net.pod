...
When using HTTP, S<L<Neo4j::Driver> 0.50> supports determining the
...
S<L<Neo4j::Driver> 0.50> is compatible with Neo4j S<versions 2.x>,
...
The included adapter may change in future. As of S<version 0.50>,
