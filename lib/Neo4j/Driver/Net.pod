...
L<on GitHub|https://github.com/johannessen/neo4j-driver-perl/blob/0.51/lib/Neo4j/Driver/Net.pod>.>
...
L<Neo4j::Driver> S<version 0.51> is compatible with
...
When using HTTP, S<L<Neo4j::Driver> 0.51> supports determining the
...
S<L<Neo4j::Driver> 0.51> is compatible with Neo4j S<versions 2.x>,
...
The included adapter may change in future. As of S<version 0.51>,
